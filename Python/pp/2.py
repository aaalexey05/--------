...
input_container = av.open('C:\Users\devil\Documents\GitHub\--------\file\[Free for profit] 2010 pop x Kesha x Hyperpop type beat - _Price_ (prod. Aki).mp4')
...
output_container = av.open('C:\Users\devil\Documents\GitHub\--------\file\[Free for profit] 2010 pop x Kesha x Hyperpop type beat - _Price_ (prod. Aki).mp4', mode='w', format='mp4')
